      ...
      (e.prototype = t.extend({}, e.prototype, {
        load: function () {
          ...
          function o() {
            ...
            (n = ""), e.find("input").val(""), i(e, 0, n, { count: 0 });
          }
          $body.on(
            "keyup",
                            ...
                            success: function (e) {
                              var a = e.resources.results.products.length,
                                o = e.resources.results.pages
                                  ...
                                  : 0,
                                r = { count: Math.min(a + o, 6), results: [] },
                                d = 0;
    ...
    (theme.ProductOptions = function () {
      ...
      (e.prototype = t.extend({}, e.prototype, {
          ...
          this._loadJSON(e, r, function (r) {
            ...
            t.each(l, function (t) {
              ...
              (c || 0 === c) &&
                ...
                o._updateOptions(e, { update_variant: u, json: r }),
                o._switchVariant(e, {
                  update_variant: u,
                  json: r,
        ...
        _updatePrice: function (e, a, n) {
          ...
          if (e.add(a).find(".bsscommerce-ltsp-message").length > 0) {
            return;
          } 
          var i,
